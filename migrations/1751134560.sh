...
mkdir -p ~/.local/state/sublingual-os/migrations
touch ~/.local/state/sublingual-os/migrations/1751134560.sh
...
touch ~/.local/state/sublingual-os/migrations/1756060611.sh
